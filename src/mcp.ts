      ...
      tools: [
        {
          ...
          description:
            "Start the ZenSpec review daemon, open a Markdown or HTML document in the browser, and wait/long-poll for human reviewer feedback or plan approval. MANDATORY GATE: You MUST NOT start implementing features or scaffolding files until the plan is approved (approved: true).",
          inputSchema: {
            type: "object",
            properties: {
              filePath: {
